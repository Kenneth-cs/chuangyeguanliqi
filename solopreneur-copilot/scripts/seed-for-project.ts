...
async function main() {
  console.log('🌱 开始为目标项目插入测试数据...\n')

  // 目标项目 ID
  const projectId = 'cmo9tnac60003uiby2qoywxxp'
  ...
  for (let daysAgo = 30; daysAgo >= 0; daysAgo--) {
    ...
    const events = generateEventsForDate(projectId, date, dailyCount, deviceIds)
